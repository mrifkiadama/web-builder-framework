...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, o) {
      ...
      (t.keyCustomCode = "custom-code-plugin__code"),
        (t.typeCustomCode = "custom-code"),
        (t.commandNameCustomCode = "custom-code:open-modal");
    },
    function (e, t, o) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
    ...
    function (e, t, o) {
      ...
      t.default = function (e) {
        ...
        o.addType("script", {
          view: {
            onRender: function () {
              this.model.closestType(r.typeCustomCode) &&
                (this.el.innerHTML = "");
            },
          },
        }),
            ...
            model: s.extend(
              {
                defaults: n(
                  ...
                  { name: "Custom Code", editable: !0 },
                  t.propsCustomCode
                ),
                init: function () {
                  this.listenTo(
                    this,
                    "change:" + r.keyCustomCode,
              ...
              onComponentsChange: function () {
                ...
                a && clearInterval(a),
                  (a = setTimeout(function () {
                    var o = e.model,
                      n = 1;
                    (o.get(r.keyCustomCode) || "").indexOf("<script") >= 0 &&
                      ((e.el.innerHTML = t.placeholderScript), (n = 0)),
                      o.set({ droppable: n });
                  }, 0));
              },
              onActive: function () {
                ...
                this.em
                  .get("Commands")
                  .run(r.commandNameCustomCode, { target: e });
              },
            }),
          });
      };
          ...
          n(
            {
              ...
              run: function (e, t) {
                ...
                (this.editor = e),
                  (this.options = o),
                  (this.target = o.target || e.getSelected());
                var n = this.target;
              ...
              showCustomCode: function (e) {
                ...
                o.Modal.open({ title: n, content: s })
                  .getModel()
              ...
              getContent: function () {
                ...
                return (
                  (t.className = n + "custom-code"),
                  a(t, this.getPreContent()),
                  t.appendChild(o.getElement()),
                  a(t, this.getPostContent()),
                  a(t, this.getContentActions()),
                  o.refresh(),
                  setTimeout(function () {
                    return o.focus();
                  }, 0),
              ...
              getContentActions: function () {
                ...
                return (
                  ...
                  (n.className =
                    r + "btn-prim " + r + "btn-import__custom-code"),
                  (n.onclick = function () {
                    return e.handleSave();
                  }),
                  n
