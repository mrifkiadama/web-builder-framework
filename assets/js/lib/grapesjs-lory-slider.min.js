                ...
                a.prototype.defaults,
                {
                  ...
                  script: function () {
                    ...
                    var a = {
                        ...
                        enableMouseEvents:
                          l.indexOf("{[ enable-mouse-events ]}") >= 0 ? 0 : 1,
                        infinite: !isNaN(s) && s,
          ...
          model: a.extend(
            {
              defaults: s(
                ...
                a.prototype.defaults,
                {
                  ...
                  droppable: i,
                  draggable: o,
                  style: { display: "inline-block", "transition-delay": "1ms" },
                },
                t.slidesProps
              ),
              init: function () {
                var e = t.classSlides;
                this.get("classes").pluck("name").indexOf(e) < 0 &&
                  this.addClass(e);
              },
            },
            {
          ...
          model: a.extend(
            {
              ...
              init: function () {
                this.get("classes").pluck("name").indexOf(o) < 0 &&
                  this.addClass(o);
              },
            },
            {
