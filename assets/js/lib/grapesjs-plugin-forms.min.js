          ...
          t.addType(s, {
            ...
            model: {
              defaults: {
                ...
                traits: [r, { name: "options", type: "select-options" }, v],
              },
            },
            view: {
              events: {
        ...
        var t =
          ...
          r = function (e, t) {
            n.blocks.indexOf(e) >= 0 &&
              o.add(
                e,
                g(g({}, t), {}, { category: { id: "forms", label: "Forms" } })
              );
          };
        r(a, {
          label: "Form",
          ...
          content: {
            type: a,
            components: [
              { components: [{ type: m, components: "Name" }, { type: i }] },
              {
                components: [
              ...
              { components: [{ type: m, components: "Message" }, { type: c }] },
              { components: [{ type: l }] },
            ],
          },
        }),
