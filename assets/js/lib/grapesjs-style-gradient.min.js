...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["grapesjs-style-gradient"] = t())
    : (e["grapesjs-style-gradient"] = t());
})(window, function () {
  return (function (e) {
    var t = {};
    function n(r) {
                          ...
                          t &&
                            (0, u.on)(t, "click", function (n) {
                              ...
                              if (!(u > i || u < o || c > a.h || c < 0)) {
                                ...
                                var d = f.createLinearGradient(0, 0, a.w, a.h);
                ...
                var r = this,
                  ...
                  w =
                    ...
                    '<div class="grp-handler-cp-wrap">\n          <div class="'
                      .concat(v, 'field-colorp-c">\n            <div class="')
                      .concat(v, 'checker-bg"></div>\n            <div class="')
                      .concat(v, 'field-color-picker" ')
                      .concat(p, "></div>\n          </div>\n        </div>"),
                  O = new c.a(s({ el: k, colorEl: w }, m.grapickOpts)),
                  P = this.el.querySelector(".".concat(v, "fields"));
                (P.style.flexWrap = "wrap"),
                  P.appendChild(k.children[0]),
                  (this.gp = O),
                  O.on("change", function (e) {
                    y.setValueFromInput(O.getValue(), e, i);
                  }),
                  [
                    [
                      "inputDirection",
                    ...
                    if (o) {
                      var i = y.parent,
                        l = e[1],
                        c = "object" == a()(o) ? o : {},
                        p = n.createType(c.type || l, {
                          model: s(s({}, e[3]), c),
                          view: { propTarget: r.propTarget },
                        });
                      i && (p.model.parent = i),
                        p.render(),
                        p.model.on("change:value", function (t, n) {
                          var r =
                            arguments.length > 2 && void 0 !== arguments[2]
                              ? arguments[2]
                              : {};
                          u(r),
                            O.el &&
                              O[e[2]](t.getFullValue() || t.getDefaultValue(), {
                  ...
                  "default" == o &&
                    ...
                    O.on("handler:remove", function (t) {
                      var n = t.getEl().querySelector("[".concat(p, "]")),
                        r = e.$(n);
                      r.spectrum && r.spectrum("destroy");
                    })),
                  o && O.setColorPicker(o);
              },
            },
          });
        };
